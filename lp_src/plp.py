...
class PLP:
    ...
    def align(self, uf, sf): #DANIAR: to go through for epenthesis
    ...
    def train_incremental(self, pair): #is not referred to anywhere in the other code
